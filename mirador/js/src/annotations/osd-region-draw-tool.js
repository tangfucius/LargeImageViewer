(function($) {
  ...
  $.OsdRegionDrawTool.prototype = {
    ...
    drawPointText: function(shapeArray){
        props = {};
        var obj = jQuery.extend({
            point: [shapeArray[0].data.centroid.x, shapeArray[0].data.centroid.y],
            content: shapeArray[0].data.annoText,
            fillColor: 'black',
      ...
      new this.svgOverlay.paperScope.PointText(obj);
      console.log(shapeArray[0]);
    },
    ...
    render: function () {
      ...
      for (var i = 0; i < this.list.length; i++) {
        ...
        _this.drawPointText(shapeArray);
