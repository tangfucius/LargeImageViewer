(function($) {
  ...
  $.Polygon.prototype = {
    ...
    createShape: function(initialPoint, overlay) {
      ...
      shape.data.defaultStrokeValue = 20;
      shape.data.editStrokeValue = 20;
      ...
      //console.log("Stroke width: "+shape.strokeWidth+" "+shape.data.currentStrokeValue+" "+overlay.paperScope.view.zoom);
      return shape;
    },
